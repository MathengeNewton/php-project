<?php
	...
	if(empty($_SESSION['username']))
		...
		if(isset($_POST['register_individuals'])) {
			...
			$sale = $_POST['sale'];
			try {
				$stmt = $connect->prepare('UPDATE room_rental_registrations SET fullname = ?,  email = ?, mobile = ?, alternat_mobile = ?, plot_number = ?, rooms = ?, country = ?, state = ?, city = ?, address = ?, landmark = ?, rent = ?, sale=?, deposit = ?, description = ?, accommodation = ?, vacant = ?, rating = ?,user_id = ?  WHERE id = ?');
				$stmt->execute(array(
					$fullname,
					$email,
					$mobile,
	...
	if(isset($_POST['register_apartment'])) {
			...
			try {
				$stmt = $connect->prepare('UPDATE room_rental_registrations_apartment SET fullname = ?, email = ?, mobile = ?, alternat_mobile = ?, plot_number = ?, apartment_name = ?, ap_number_of_plats = ?, rooms = ?, country = ?, state = ?, city = ?, address = ?, landmark = ?, rent = ?, deposit = ?, description = ?, accommodation = ?, vacant = ?,rating = ?, user_id = ?, floor = ?, own = ?, area = ?, purpose = ?  WHERE id = ?');
